...
dataset = LoadData('./lazydata/', transform = transforms.Compose([transforms.ToTensor(), ]))
...
dataset = LoadData('./lazydata/', transform = normalized_transform)
...
testds = LoadData('./lazydata/', train = False, transform = transform_with_normalization)
